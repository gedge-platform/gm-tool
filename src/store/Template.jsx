...
class Template {
  ...
  setDeploymentYamlTemplateFromAppInfo = (appInfo) => {
    ...
    this.deploymentYamlTemplate.spec.selector.matchLabels.app = appInfo.app + "-" + appInfo.appName;
    this.deploymentYamlTemplate.spec.template.metadata.labels.app = appInfo.app + "-" + appInfo.appName;
    this.deploymentYamlTemplate.spec.template.spec.containers[0].name = appInfo.app;
    this.deploymentYamlTemplate.spec.template.spec.containers[0].image = appInfo.app + ":" + appInfo.appVersion;
    this.deploymentYamlTemplate.spec.template.spec.containers[0].env = appInfo.appEnv;
    this.deploymentYamlTemplate.spec.template.spec.containers[0].ports[0].containerPort = appInfo.appPort;
    ...
    this.serviceYamlTemplate.spec.selector.app = appInfo.app + "-" + appInfo.appName;
