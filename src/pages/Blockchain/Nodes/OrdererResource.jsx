        ...
        <Layout currentPage={currentPage}>
            <PanelBox>
                <div className="panelTitBar panelTitBar_clear">
                    <div className="tit">Peer 리소스 관리</div>
                </div>
                <div className="grid-height2">
                    <div style={{ padding: "30px" }}>
                        ...
                        <div>
                            <p style={{ fontSize: "15px", marginTop: "15px", paddingBottom: "10px" }}>CA 기본 설정</p>
                        ...
                        <div>
                            <p style={{ fontSize: "20px", paddingBottom: "10px", paddingTop: "10px" }}>Peer 리소스 모니터링</p>
                            <hr />
                        </div>
...
export default OrdererResource;
