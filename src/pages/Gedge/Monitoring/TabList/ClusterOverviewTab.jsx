...
const ClusterOverview = observer(() => {
    ...
    const [chartValueBottom, setChartValueBottom] =
        useState("APISERVER_LATENCY");
            ...
            >
                ...
                <div className="tab1-panel-area">
                    <div className="tab1-button-area">
                        <COButtonCPU
                            isOn={open1}
                            onClick={() => changedTopState(1)}
                        />
                        <COButtonMemory
                            isOn={open2}
                            onClick={() => changedTopState(2)}
                        />
                        <COButtonDisk
                            isOn={open3}
                            onClick={() => changedTopState(3)}
                        />
                        <COButtonPod
                            isOn={open4}
                            onClick={() => changedTopState(4)}
                        />
                    </div>
