...
import {
  COAreaChartTop,
  COAreaChartBottom,
} from "../../../Monitoring/TabList/MonitChart/ClusterOverviewChart";
import {
  stepConverter,
  unixCurrentTime,
  unixStartTime,
...
} from "../../../Monitoring/TabList/ClusterOverviewComponent/COButton";

const ClusterOverviewAdminTab = observer(() => {
...
export default ClusterOverviewAdminTab;
