...
const StoragePage = () => {
    const currentPageTitle = Title.StoragePage;
                    ...
                    <div className="storageCircleBoxWrap">
                        <div className="storageCircleBox">
                            ...
                            <div className="contTxt">
                                <ul>
                                    <li className="used"><span className="tit">Used</span> <span>48.1 GiB</span></li>
                                    <li className="avail"><span className="tit">Avail</span> <span>191.9 GiB</span></li>
                        ...
                        <div className="storageCircleBox">
                            ...
                            <div className="contTxt">
                                <ul>
                                    <li className="clean"><span className="tit">Healthy</span> <span>100%</span></li>
                                    <li className="working"><span className="tit">Misplaced</span> <span>0</span></li>
                                    <li className="warning"><span className="tit">Degraded</span> <span>0</span></li>
                                    <li className="unknown"><span className="tit">Unfound</span> <span>0</span></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="storageCircleBox">
                            ...
                            <div className="contTxt">
                                <ul>
                                    <li className="clean"><span className="tit">Clean</span> <span>0</span></li>
                                    <li className="working"><span className="tit">Working</span> <span>177</span></li>
                                    <li className="warning"><span className="tit">Warning</span> <span>0</span></li>
                                    <li className="unknown"><span className="tit">Unknown</span> <span>0</span></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="storageCircleBox">
                            ...
                            <div className="contTxt">
                                <ul>
                                    <li className="reads"><span className="tit">Reads</span> <span>2/s</span></li>
                                    <li className="writes"><span className="tit">Writes</span> <span>36/s</span></li>
                                    <li className="none"></li>
                                    <li className="none"></li>
                                </ul>
                            </div>
                        ...
                        <div className="storageCircleBox">
                            ...
                            <div className="contTxt">
                                <ul>
                                    <li className="reads"><span className="tit">Reads</span> <span>3.2 KiB/s</span></li>
                                    <li className="writes"><span className="tit">Writes</span> <span>12.8 MiB/s</span></li>
                                    <li className="none"></li>
                                    <li className="none"></li>
                                </ul>
                            </div>
