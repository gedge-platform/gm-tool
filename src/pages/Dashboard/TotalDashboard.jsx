...
const TotalDashboard = observer(() => {
    ...
    const [columnDefs] = useState([
        ...
        },
        {
            ...
            sortable: false,
            cellRenderer: (date) => {
                return `<span>${moment(new Date(date.value)).format("YYYY-MM-DD HH:mm")}</span>`;
            },
        },
        {
            headerName: "상태",
        ...
        <Layout currentPageTitle={currentPageTitle} currentPage={currentPage}>
            <DashboardWrap>
                <div className="panel_column">
                    <PanelBox className="panel_dashboard" style={{ marginBottom: "10px" }}>
                        <div className="panelTitBar panelTitBar_clear">
                            <div className="tit">
                                <span style={{ marginRight: "10px" }}>블록체인 정보 서비스</span>
                                <CSelectButton className="none_transform" items={actionList}>
                                    네트워크 선택
                                </CSelectButton>
                            </div>
                            <div className="date">{moment(new Date()).format("YYYY-MM-DD HH:mm")}</div>
                        </div>
                    ...
                    <PanelBox className="panel_dashboard">
                        <div className="panelTitBar panelTitBar_clear">
                            ...
                            <div className="date">{moment(Date()).format("YYYY-MM-DD HH:mm")}</div>
                        </div>
                        <div
                            className="panelCont"
                            style={{
